  ...
  <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				...
				<div id="readerBlock">欢迎回来&nbsp;:<a href="book.do?method=getMyBorrow&readerid=${reader.id }">${reader.name }</a>&nbsp;<a href="logout.do">注销</a></div>
		</div>
		<div class="img_block">
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list }" var="book">
				<tr>
					...
					<td><a href="book.do?method=borrow&bookid=${book.id }&readerid=${reader.id}">借阅</a></td>
				</tr>
			</c:forEach>
